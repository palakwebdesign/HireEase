<%@ Page Title="" Language="C#" MasterPageFile="~/Company.master" AutoEventWireup="true" CodeFile="Report.aspx.cs" Inherits="Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <br />
    <div class="container">
        <asp:DropDownList ID="DropDownList1" class="btn btn-primary pill  px-4 py-2" runat="server" DataSourceID="SqlDataSource3" DataTextField="job_title" DataValueField="p_id" AutoPostBack="True"></asp:DropDownList>
        ...
        <asp:RadioButtonList ID="RadioButtonList1" runat="server" CssClass="custom-radio" AutoPostBack="True" RepeatDirection="Horizontal" Width="504px">
            <asp:ListItem Value="Pass">Pass</asp:ListItem>
            <asp:ListItem>Fail</asp:ListItem>
        </asp:RadioButtonList>

        <asp:Panel ID="Panel1" runat="server">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" CellPadding="4" ForeColor="#333333" GridLines="None" CssClass="auto-style1" Height="282px" Width="587px">
